...
- **S32.2 Local evidence packets**
  ...
  - [x] T32.2.2 Add a signed local manifest for evidence bundles using existing release-trust tooling.
...
- **S34.3 Remaining shipped surfaces**
  ...
  - [x] T34.3.3 Add schema/docs/snapshots for `asp doctor --json --runbook`.
...
- **S36.2 Organization rollout controls**
  ...
  - [x] T36.2.4 Add CI examples that fail on unsafe config drift without mutating workspaces.
  - [x] T36.2.5 Add docs for phased rollout, rollback, and owner handoff.
...
- **S37.2 Sync security and conflict UX**
  ...
  - [x] T37.2.5 Add recovery docs for restoring a workspace from a remote-only backup.
...
- **S38.1 Windows engine portability**
  ...
  - [x] T38.1.2 Preserve supported symlinks and reject unsafe reparse points with hints.
...
- **S39.2 Forensic evidence exports**
  - [x] T39.2.1 Add `asp evidence timeline` for a redacted incident timeline.
