...
- **Agent preflight** — [docs/agent-preflight.md](docs/agent-preflight.md)
...
- **Rollout handoff** — [docs/rollout-handoff.md](docs/rollout-handoff.md)
...
The npm/npx wrapper source and publishing checklist are documented in [docs/npm-wrapper.md](docs/npm-wrapper.md).
