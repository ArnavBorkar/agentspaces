...
| `workspace_restore` | `not_a_workspace`, `checkpoint_not_found` |
| `workspace_fork` | `not_a_workspace`, `fork_exists`, `cross_volume` |
| `workspace_forks` | `not_a_workspace` |
| `workspace_diff` | `not_a_workspace`, `checkpoint_not_found` |
| `workspace_promote` | `not_a_workspace`, `fork_not_found`, `no_user_git_repo`, `branch_exists` |
