...
fn schema_inventory_audit_tracks_known_result_map_gaps() {
    ...
    for needle in [
        ...
        "asp evidence timeline --json",
        "evidenceTimelineReport",
...
fn ci_docs_cover_preflight_examples() {
    ...
    for needle in [
        ...
        "metadata\"][\"status\"]",
        "recovered_tree",
        "asp-drill-evidence-${{ github.run_id }}",
...
fn schema_docs_cover_preflight_and_evidence_contracts() {
    ...
    for needle in [
        ...
        "asp evidence timeline --json",
        "#/$defs/evidenceTimelineReport",
        "asp evidence timeline --json --output file.json",
        "#/$defs/evidenceTimelineOutputResult",
        "asp evidence manifest --packet file.json --output manifest.json --json",
